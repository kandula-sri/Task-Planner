...
updateTask(taskId,taskname,priority,description,assignedto,taskstatus,comment,duedate) {
  // Create an empty array and store it in a new variable, newTasks
...
render() {
    ...
    const createTaskHtml = (task, priority,description,assignedto,status,comment, duedate,id) => {
      ...
      return `
              ...
              <button class="btn btn-outline-success update-button">Update Task</button>
              </div>
              </li>
            `;
    }
